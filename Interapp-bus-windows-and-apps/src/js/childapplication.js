var _childApp, _messageButton, _interAppMessage, _parent_avatar, _inter_app_errors;
...
initChildWithOpenFin = function () {
    ...
    _parent_avatar = document.querySelector("#parent-avatar");
    _inter_app_errors = document.querySelector("#inter-app-errors");

    document.querySelector("#uuid").innerHTML = "<strong>OpenFin UUID:</strong>" + _childApp.app_uuid;
...
function initListeners() {
    ...
    fin.desktop.InterApplicationBus.subscribe("*",
        TOPIC_BOUNDS_CHANGED,
        function (message, uuid) {
            _parent_avatar.style.width = (message.bounds.width/5)+'px';
            _parent_avatar.style.height = (message.bounds.height/5)+'px';
        });
